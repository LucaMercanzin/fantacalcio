...
from dashboard.data_access import (
    ...
    get_decision_center,
    get_fixture_difficulty,  # noqa: F401 (used as components.get_fixture_difficulty by dashboard.player_detail)
    get_goalkeeper_pool,
    get_ideal_formation,
    get_insufficient_data_players,
    get_player_extra,  # noqa: F401 (used as components.get_player_extra by dashboard.player_detail)
...
# Re-export: render_player_detail lives in dashboard/player_detail.py
# (CRITICA_SPIETATA_2026-09-01 #5 — extracted from this file to shrink the
# monolith). Imported at the bottom, not the top, to avoid a circular import:
